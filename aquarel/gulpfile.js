...
const ftpBuild = () => {
  return src(["app/**/*.*", "!app/**/*.map"])
    .pipe(connect.newer("acvarel/"))
    .pipe(connect.dest("acvarel/"))
    .on("success", () =>
      console.log(
        `Finished deploing ./build to https://${ftpSettings.host}
        `
      )
    );
};
...
const externalbuildFolder = "../public";
const paths = {
  srcSvg: `${srcFolder}/img/svg/**.svg`,
  srcImgFolder: `${srcFolder}/img`,
  buildImgFolder: `${buildFolder}/filemanager/aquarel`,
  srcScss: `${srcFolder}/scss/**/*.scss`,
  buildCssFolder: `${externalbuildFolder}/css/aquarel`,
  srcFullJs: `${srcFolder}/js/**/*.js`,
  srcMainJs: `${srcFolder}/js/main.js`,
  buildJsFolder: `${externalbuildFolder}/js/aquarel`,

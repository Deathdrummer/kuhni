<div class="modal fade" id="modalraschetPrice" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-w-custom modal-dialog-centered">
		<div class="modal-content bg-transparent">
			...
			<div class="row g-0 gap-0 gap-md-10 buttons">
				...
				<div class="col-12 bcg--white-v1 text-center d-block d-md-none modal-form-title pb-40 pt-25">Заказать проект</div>
				<div class="col-12 d-flex flex-column align-items-center bcg--white-v1 col-md-auto pb-10 pt-md-50 pb-md-50 ps-10 ps-md-0 pe-10 pe-md-0">
					<button class="button" data-bs-toggle="modal" data-bs-target="#formPriceKitchen">Проект кухни</button>
				</div>
				<div class="col-12 d-flex flex-column align-items-center bcg--white-v1 col-md-auto pt-md-50 pb-md-50 ps-10 ps-md-0 pe-10 pe-md-0 pb-40 pb-md-0">
					<button class="button" data-bs-toggle="modal" data-bs-target="#formPriceShkaf">Проект шкафа</button>
				</div>
			</div>
		</div>
	</div>

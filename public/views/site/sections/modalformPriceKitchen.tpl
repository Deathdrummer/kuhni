                  ...
                  <div class="col-6">
                    <label class="form-check-image p-8" for="img{{index}}">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="img" id="img{{index}}" />
              ...
              <div class="row g-0 gap-5 col-12">
                <div class="col-12 d-flex flex-row align-items-center">
                  ...
                  <div class="itc-select" id="select-a">
                    ...
                    <button type="button" class="itc-select__toggle" name="select-a" value="" data-select="toggle" data-index="-1">Выбрать</button>
                    <!-- Выпадающий список -->
                ...
                <div class="col-12 d-flex flex-row align-items-center">
                  ...
                  <div class="itc-select" id="select-b">
                    <!-- Кнопка для открытия выпадающего списка -->
                    <button type="button" class="itc-select__toggle" name="select-b" value="" data-select="toggle" data-index="-1">Выбрать</button>
                    <!-- Выпадающий список -->
                    <div class="itc-select__dropdown">
                      <ul class="itc-select__options">
                ...
                <div class="col-12 d-flex flex-row align-items-center">
                  ...
                  <div class="itc-select" id="select-c">
                    <!-- Кнопка для открытия выпадающего списка -->
                    <button type="button" class="itc-select__toggle" name="select-c" value="" data-select="toggle" data-index="-1">Выбрать</button>
                    <!-- Выпадающий список -->
                    <div class="itc-select__dropdown">
                      <ul class="itc-select__options">
            ...
            <div class="row g-0 mb-50">
              ...
              <div class="row g-0 gap-30 col-12">
                <div class="col d-flex flex-row align-items-center">
                  <label class="me-20 text-nowrap" for="">Сторона <span class="fw-bold">A</span></label> <input type="text" placeholder="" class="form-control h-40" />
                </div>
                <div class="col d-flex flex-row align-items-center">
                  <label class="me-20 text-nowrap" for="">Сторона <span class="fw-bold">B</span></label> <input type="text" placeholder="" class="form-control h-40" />
                </div>
                <div class="col d-flex flex-row align-items-center">
                  <label class="me-20 text-nowrap" for="">Сторона <span class="fw-bold">C</span></label> <input type="text" placeholder="" class="form-control h-40" />
                </div>
              </div>
            </div>
            <div class="row g-0 gx-1 mb-50">
              <div class="col">
                ...
                <div class="col">
                  {% for index, item in list_form_height_kitchen %}
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="h" id="h{{index}}" />
              ...
              <div class="col">
                ...
                {% for index, item in list_form_texnika_kitchen %}
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="t" id="t{{index}}" />
              ...
              <div class="col">
                ...
                <div class="col">
                 {% for index, item in list_form_furnitura_kitchen %}
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="p" id="p{index}}" />
